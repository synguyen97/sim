...
description: Learn how connections work in Nuggets
---
...
Connections are the pathways that allow data to flow between blocks in your workflow. When you connect two blocks in Nuggets, you're establishing a data flow relationship that defines how information passes from one block to another.
