---
title: Execution
description: Understand how workflows are executed in Nuggets
---
...
Nuggets's execution engine brings your workflows to life by processing blocks in the correct order, managing data flow, and handling errors gracefully.
...
<Cards>
  ...
  <Card title="Logging and Cost Calculation" href="/execution/advanced">
    Understand workflow logs and how execution costs are calculated in Nuggets
  </Card>
</Cards>
...
When you deploy a workflow as an API, Nuggets:
