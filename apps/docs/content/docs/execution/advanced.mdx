...
description: Understanding workflow logs and how execution costs are calculated in Nuggets
---
...
Nuggets provides comprehensive logging for workflow executions and automatic cost calculation for AI model usage.

## Logging System

Nuggets offers two complementary logging interfaces:
...
Nuggets automatically calculates costs for all AI model usage:
...
<Tabs items={['Hosted Models', 'Bring Your Own API Key']}>
  <Tab>
    **Hosted Models** - Nuggets provides API keys with a 2.5x pricing multiplier:
