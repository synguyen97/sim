...
export const metadata: Metadata = {
  title: 'Nuggets - AI Agent Workflow Builder | Open Source Platform',
  description:
  ...
  authors: [{ name: 'Nuggets Studio' }],
  creator: 'Nuggets Studio',
  publisher: 'Nuggets Studio',
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  openGraph: {
    title: 'Nuggets - AI Agent Workflow Builder | Open Source',
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nuggets - Visual AI Workflow Builder',
        type: 'image/png',
      },
      {
