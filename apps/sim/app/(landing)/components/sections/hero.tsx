  ...
  const renderActionUI = () => {
    ...
    return (
      <Button
        ...
        className='animate-fade-in items-center bg-[#21A29A] px-7 py-6 font-[420] font-geist-sans text-lg text-neutral-100 tracking-normal shadow-[#21A29A]/30 shadow-lg hover:bg-[#65a8a4]'
