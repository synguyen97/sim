  ...
  return (
    <LegalLayout title='Terms of Service'>
      <section>
        ...
        <p>
          Please read these Terms of Service ("Terms") carefully before using the nuggets platform (the
          "Service") operated by nuggets, Inc ("us", "we", or "our").
        </p>
        <p className='mt-4'>
      ...
      <section>
        ...
        <p className='mb-4'>
          ...
          exclusive property of nuggets, Inc and its licensors. The Service is protected by copyright,
          trademark, and other laws of both the United States and foreign countries.
        </p>
        <p>
          Our trademarks and trade dress may not be used in connection with any product or service
          without the prior written consent of nuggets, Inc.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className='mb-4 list-disc space-y-2 pl-6'>
          ...
          <li>
            ...
            including any "junk mail", "chain letter," "spam," or any other nuggetsilar solicitation.
          </li>
          <li>
            To impersonate or attempt to impersonate nuggets, Inc, a nuggets employee, another user, or any
          ...
          <li>
            ...
            the Service, or which, as determined by us, may harm nuggets, Inc or users of the Service or
      ...
      <section>
        ...
        <p>
          ...
          terminate your account, you may nuggetsply discontinue using the Service.
        </p>
      </section>
      ...
      <section>
        ...
        <p className='mb-4'>
          In no event shall nuggets, Inc, nor its directors, employees, partners, agents, suppliers, or
      ...
      <section>
        ...
        <p>nuggets, Inc, its subsidiaries, affiliates, and its licensors do not warrant that:</p>
        <ul className='mb-4 list-disc space-y-2 pl-6'>
          <li>
      ...
      <section>
        ...
        <p className='mb-4'>
          ...
          disputes with nuggets, Inc, its parent companies, subsidiaries, affiliates, successors and
      ...
      <section>
        ...
        <p>
          ...
          <Link
            href='mailto:copyright@nuggets.ai'
            className='text-[var(--brand-primary-hex)] underline hover:text-[#ff9100]'
          >
            copyright@nuggets.ai
          </Link>
        </p>
      </section>
