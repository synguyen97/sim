        ...
        <section className='px-4 pt-20 pb-12 sm:px-8 sm:pt-28 sm:pb-16 md:px-16 md:pt-40 md:pb-24 lg:px-28 xl:px-32'>
          <div className='mx-auto max-w-6xl'>
            ...
            <div className='mb-12 text-center sm:mb-16'>
              ...
              >
                Meet the amazing people who have helped build and improve Nuggets
              </motion.p>
            </div>
              ...
              <div className='mb-6 grid grid-cols-1 gap-3 sm:mb-8 sm:grid-cols-2 sm:gap-4 lg:grid-cols-5'>
                <div className='rounded-lg border border-[#606060]/20 bg-neutral-800/30 p-3 text-center sm:rounded-xl sm:p-4'>
                  <div className='mb-1 flex items-center justify-center sm:mb-2'>
                    <Star className='h-4 w-4 text-[#21A29A] sm:h-5 sm:w-5' />
                  </div>
                ...
                <div className='rounded-lg border border-[#606060]/20 bg-neutral-800/30 p-3 text-center sm:rounded-xl sm:p-4'>
                  <div className='mb-1 flex items-center justify-center sm:mb-2'>
                    <GitFork className='h-4 w-4 text-[#21A29A] sm:h-5 sm:w-5' />
                  </div>
                ...
                <div className='rounded-lg border border-[#606060]/20 bg-neutral-800/30 p-3 text-center sm:rounded-xl sm:p-4'>
                  <div className='mb-1 flex items-center justify-center sm:mb-2'>
                    <GitGraph className='h-4 w-4 text-[#21A29A] sm:h-5 sm:w-5' />
                  </div>
                ...
                <div className='rounded-lg border border-[#606060]/20 bg-neutral-800/30 p-3 text-center sm:rounded-xl sm:p-4'>
                  <div className='mb-1 flex items-center justify-center sm:mb-2'>
                    <MessageCircle className='h-4 w-4 text-[#21A29A] sm:h-5 sm:w-5' />
                  </div>
                  <div className='font-bold text-lg text-white sm:text-xl'>
                ...
                <div className='rounded-lg border border-[#606060]/20 bg-neutral-800/30 p-3 text-center sm:rounded-xl sm:p-4'>
                  <div className='mb-1 flex items-center justify-center sm:mb-2'>
                    <GitPullRequest className='h-4 w-4 text-[#21A29A] sm:h-5 sm:w-5' />
                  </div>
                  ...
                  <AreaChart data={timelineData} className='-mx-2 sm:-mx-5 mt-1 sm:mt-2'>
                    <defs>
                      <linearGradient id='commits' x1='0' y1='0' x2='0' y2='1'>
                        <stop offset='5%' stopColor='#21A29A' stopOpacity={0.3} />
                        <stop offset='95%' stopColor='#21A29A' stopOpacity={0} />
                      </linearGradient>
                    </defs>
                    <XAxis
                      dataKey='date'
                            ...
                            <div className='rounded-lg border border-[#606060]/30 bg-[#0f0f0f] p-2 shadow-lg backdrop-blur-sm sm:p-3'>
                              <div className='grid gap-1 sm:gap-2'>
                                <div className='flex items-center gap-1 sm:gap-2'>
                                  <GitGraph className='h-3 w-3 text-[#21A29A] sm:h-4 sm:w-4' />
                ...
                <TabsContent value='grid'>
                  ...
                  <div className='grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 lg:grid-cols-4 xl:grid-cols-6'>
                    {filteredContributors?.map((contributor, index) => (
                      ...
                      >
                        <Avatar className='h-12 w-12 ring-2 ring-[#606060]/30 transition-transform group-hover:scale-105 group-hover:ring-[#21A29A]/60 sm:h-16 sm:w-16'>
                          <AvatarImage
                        ...
                        <div className='mt-2 text-center sm:mt-3'>
                          <span className='block font-medium text-white text-xs transition-colors group-hover:text-[#21A29A] sm:text-sm'>
                            {contributor.login.length > 12
                              ? `${contributor.login.slice(0, 12)}...`
                              : contributor.login}
                          </span>
                          <div className='mt-1 flex items-center justify-center gap-1 sm:mt-2'>
                            <GitGraph className='h-2 w-2 text-neutral-400 transition-colors group-hover:text-[#21A29A] sm:h-3 sm:w-3' />
            ...
            >
              <div className='relative p-6 sm:p-8 md:p-12 lg:p-16'>
                <div className='text-center'>
                  <div className='mb-4 inline-flex items-center rounded-full border border-[#21A29A]/20 bg-[#21A29A]/10 px-3 py-1 font-medium text-[#21A29A] text-xs sm:mb-6 sm:px-4 sm:py-2 sm:text-sm'>
                  ...
                  <div className='mt-6 flex flex-col gap-3 sm:mt-8 sm:flex-row sm:flex-wrap sm:justify-center sm:gap-4'>
                    <Button
                      asChild
                      size='lg'
                      className='bg-[#21A29A] text-white transition-colors duration-500 hover:bg-[#65a8a4]'
                    >
                      <a
