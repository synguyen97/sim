          ...
          <AlertDialogFooter className='flex justify-between'>
            ...
            <Button
              ...
              className={cn(
                ...
                'bg-[#21A29A] text-white shadow-[0_0_0_0_#21A29A] hover:bg-[#7028E6] hover:shadow-[0_0_0_4px_rgba(112,31,252,0.15)] disabled:opacity-50 disabled:hover:bg-[#21A29A] disabled:hover:shadow-none'
              )}
            >
