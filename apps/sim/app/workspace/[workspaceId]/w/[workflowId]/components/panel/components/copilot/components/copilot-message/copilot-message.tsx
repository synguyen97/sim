                      ...
                      <>
                        {visible.map((ctx: any, idx: number) => (
                          <span
                            ...
                            className='inline-flex items-center gap-1 rounded-full bg-[color-mix(in_srgb,#21A29A_14%,transparent)] px-1.5 py-0.5 text-[11px] text-foreground'
                        ...
                        {allContexts.length > MAX_VISIBLE && (
                          <button
                            ...
                            className='inline-flex items-center gap-1 rounded-full bg-[color-mix(in_srgb,#21A29A_10%,transparent)] px-1.5 py-0.5 text-[11px] text-foreground hover:bg-[color-mix(in_srgb,#21A29A_14%,transparent)]'
                            title={
                              showAllContexts
                                ? 'Show less'
                    ...
                    while ((match = pattern.exec(text)) !== null) {
                      ...
                      nodes.push(
                        <span
                          ...
                          className='rounded-[6px] bg-[color-mix(in_srgb,#21A29A_14%,transparent)] px-1'
                        >
                          {mention}
                        </span>
                      )
