    ...
    <div className='relative h-full w-full overflow-hidden px-4 pt-8 pb-6'>
      <div className='relative mx-auto w-full max-w-xl'>
        ...
        <div className='flex flex-col items-center text-center'>
          <Bot className='h-12 w-12 text-[#21A29A]' strokeWidth={1.5} />
        ...
        <div className='mt-7 space-y-2.5'>
          {capabilities.map(({ title, question, Icon }, idx) => (
            <button
              ...
              className='w-full rounded-[10px] border bg-background/60 p-3 text-left transition-colors hover:bg-muted focus:outline-none focus:ring-2 focus:ring-[#21A29A]/30'
            >
              <div className='flex items-start gap-2'>
                <div className='mt-0.5 flex h-6 w-6 items-center justify-center rounded bg-[color-mix(in_srgb,#21A29A_16%,transparent)] text-[#21A29A]'>
