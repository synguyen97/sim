...
const SkeletonControlBar = () => {
  return (
    <div className='fixed top-4 right-4 z-20 flex items-center gap-1'>
      ...
      {/* Run Button */}
      <Button
        className='h-12 cursor-not-allowed gap-2 rounded-[11px] bg-[#ff9100] px-4 py-2 font-medium text-white shadow-[0_0_0_0_#ff9100] transition-all duration-200 hover:bg-[#6518E6] hover:shadow-[0_0_0_4px_rgba(127,47,255,0.15)] disabled:opacity-50 disabled:hover:bg-[#ff9100] disabled:hover:shadow-none'
        disabled
      >
