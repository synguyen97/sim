        ...
        <div className='flex justify-between border-t pt-4'>
          ...
          <div className='flex gap-3'>
            ...
            <Button
              ...
              className='bg-[var(--brand-primary-hex)] font-[480] text-primary-foreground shadow-[0_0_0_0_var(--brand-primary-hex)] transition-all duration-200 hover:bg-[#21A29A] hover:shadow-[0_0_0_4px_rgba(127,47,255,0.15)]'
            >
              {isUploading
