              ...
              <div className='mb-4 flex items-center justify-between pt-1'>
                ...
                <div className='flex items-center gap-3'>
                  ...
                  <Button
                    disabled
                    size='sm'
                    className='flex items-center gap-1 bg-[#ff9100] font-[480] text-primary-foreground shadow-[0_0_0_0_#ff9100] transition-all duration-200 hover:bg-[#6518E6] hover:shadow-[0_0_0_4px_rgba(127,47,255,0.15)] disabled:opacity-50'
                  >
